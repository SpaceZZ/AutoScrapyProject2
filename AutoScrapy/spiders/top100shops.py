import scrapy
from AutoScrapy.items import Top100ShopsItem
...
def get_input_domains():
    """
    Return the list of 100 shops from the attached file
    :return:
    :rtype:
    """
...
class Top100Shops(scrapy.Spider):
    """
    ...
    custom_settings = {
        ...
        'FEED_URI': 'top100shops.csv',
        'USER_AGENT': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.122 Safari/537.36'
    }
    start_urls = get_input_domains()
    ...
    def parse(self, response):
        ...
        yield scrapy.Request(url=response.url, callback=self.parse_webpage, meta={'item': item})
